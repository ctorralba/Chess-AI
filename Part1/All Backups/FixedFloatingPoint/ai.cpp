...
bool AI::run_turn()
{
	...
	cout << "segfault2" << endl;
	//cout << "Returned from actions " << endl;
	...
	if (actionList.size() != 0) {
		...
		for (int i = 0; i < actionList.size(); i++) {
			if (actionList[randValid].m_type == actionList[i].m_type &&
				...
				cout << actionList[i].original.m_type << "-" << actionList[i].original.m_file << actionList[i].original.m_rank << "->"
					<< actionList[i].move.m_type << "-" << actionList[i].move.m_file << actionList[i].move.m_rank << endl;
				actionFile << actionList[i].original.m_type << "-" << actionList[i].original.m_file << actionList[i].original.m_rank << "->"
					<< actionList[i].move.m_type << "-" << actionList[i].move.m_file << actionList[i].move.m_rank << "\n";
			}
		}
		actionFile.close();
		cout << "segfault after call" << endl;
